...
export const ScheduleModal: React.FC<ScheduleModalProps> = ({
  ...
  const shows = [
    ...
    },
    {
      ...
      day: "MARTES",
      time: "20:00 HS",
      tag: "DEBATE Y OPINIÓN",
      description: "Charlas sinceras y directas sobre dilemas reales que viven los jóvenes hoy en día, sin tabúes ni poses.",
      hosts: [HOSTS[0], HOSTS[1]],
      image: "/images/ep-sin-filtro.jpg",
    },
    {
      ...
      time: "19:00 HS",
      tag: "JUEGOS EN VIVO",
      description: "Dinamismo, trivias interactivas, humor y desafíos comunitarios donde los espectadores suman puntos para el ranking anual.",
      hosts: [HOSTS[2], HOSTS[3]],
      image: "/images/ep-batalla.jpg",
    },
    {
      title: "UNA COSA MÁS",
      day: "JUEVES",
      time: "21:30 HS",
      tag: "REFLEXIÓN ÍNTIMA",
      description: "Espacio nocturno dedicado a la introspección, historias de superación personal, testimonios y oración comunitaria.",
      hosts: [HOSTS[1], HOSTS[2]],
      image: "/images/ep-unacosamas.jpg",
    },
  ];
